 ...
 * @version     $Id: class.CeonURIMappingVersion.php 2019-07-04 17:20:15Z webchills $
 */
...
class CeonURIMappingVersion extends CeonURIMappingTabbedPanelAdminInterface
{
	...
	public function __construct($load_config = true)
	{
		...
		if (!defined('TEXT_EDITION_TITLE') && $_SESSION['language'] != 'german') {
			// Fall back to german language file
			@include_once(DIR_WS_LANGUAGES . 'german/' . 'ceon_uri_mapping_config.php');
		}
