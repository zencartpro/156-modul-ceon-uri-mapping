...
if (defined('CEON_URI_MAPPING_ENABLED') && isset($action) && ($action == 'new_product' || $action == 'update_product')) {
...
//   Adds $ceon_uri_mapping_admin to global space
if (defined('CEON_URI_MAPPING_ENABLED') && isset($action) && $action == 'new_product_preview') {
		require_once(DIR_WS_CLASSES . 'class.CeonURIMappingAdminProductPages.php');
...
if (defined('CEON_URI_MAPPING_ENABLED') && isset($action) && ($action == 'insert_product' || $action == 'update_product')) {
